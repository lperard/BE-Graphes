...
public final class Node implements Comparable<Node> {
    ...
    /**
     * Check the arcs between to nodes
     * 
     * @param other Node you want to check
     * @return list of arcs between the called object and other
     */
    
    protected List<Arc> arcsBetween(Node other){
    	System.out.println("debut arcbetween");
    	List<Arc> between = new ArrayList<Arc>();
    	for (Arc elem : this.getSuccessors()) {
    		if(elem.getDestination().equals(other)){
    			between.add(elem);
    		}
    	}
    	System.out.println("fin arcbetween "  + between.size());
    	return between;
    }
